...
# accuracy par joueur
print('accuracy white: ',df[df.move_number%2==0].accurate.mean())
print('accuracy black: ',df[df.move_number%2==1].accurate.mean())
...
plt.fill_between(df.index, df["evaluation"], color='#0000', alpha=1)
